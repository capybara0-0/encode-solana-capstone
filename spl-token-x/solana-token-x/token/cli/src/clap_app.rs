...
lazy_static::lazy_static! {
    pub static ref VALID_TOKEN_PROGRAM_IDS: [Pubkey; 3] = [spl_token_2022::ID, spl_token::ID, Pubkey::from_str("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA").unwrap()];
}
...
pub fn app<'a, 'b>(
    ...
    App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("MAX_PRIO_FEE_LAMPORTS")
                .long("max-prio-fee-lamports")
                .value_name("LAMPORTS")
                .takes_value(true)
                .global(true)
                .validator(is_amount)
                .help(
                    "Maximum number of lamports the user is willing to pay for prioritization. Defaults to 0"
                ),
        )
