    ...
    T: SendTransaction + SimulateTransaction,
{
    ...
    async fn construct_tx<S: Signers>(
        ...
        additional_prio_fee_budget_microlamports: Option<f64>,
        signing_keypairs: &S,
        ...
        if let Some(additional_compute_budget) = additional_compute_budget {
            ...
            if let Some(additional_prio_fee_budget_microlamports) = additional_prio_fee_budget_microlamports {
                instructions.insert(0,
                    solana_sdk::compute_budget::ComputeBudgetInstruction::set_compute_unit_price(
                        (additional_prio_fee_budget_microlamports / (additional_compute_budget as f64)) as u64
                    )
                );
            }
        }else{
            if let Some(additional_prio_fee_budget_microlamports) = additional_prio_fee_budget_microlamports {
                instructions.insert(0,
                    solana_sdk::compute_budget::ComputeBudgetInstruction::set_compute_unit_price(
                        // see https://github.com/solana-labs/solana/blob/4293f11cf13fc1e83f1baa2ca3bb2f8ea8f9a000/program-runtime/src/compute_budget.rs#L13
                        (additional_prio_fee_budget_microlamports / 200_000.0 * instructions.len() as f64) as u64
                    )
                );
            }
        }
    ...
    pub async fn simulate_ixs<S: Signers>(
        &self,
        token_instructions: &[Instruction],
        max_prio_fee_lamports: Option<f64>,
        signing_keypairs: &S,
    ) -> TokenResult<T::SimulationOutput> {
        let transaction = self
            .construct_tx(token_instructions, None, max_prio_fee_lamports, signing_keypairs)
            .await?;
    ...
    pub async fn process_ixs<S: Signers>(
        ...
        let transaction = self
            .construct_tx(token_instructions, None, additional_prio_fee_budget_microlamports, signing_keypairs)
            .await?;
    ...
    pub async fn process_ixs_with_additional_compute_budget<S: Signers>(
        ...
        let transaction = self
            .construct_tx(
                ...
                additional_prio_fee_budget_microlamports,
                signing_keypairs,
            )
            .await?;
    ...
    pub async fn create_mint<'a, S: Signers>(
        ...
        self.process_ixs(&instructions, additional_prio_fee_budget_microlamports,signing_keypairs).await
    }
    ...
    pub async fn create_multisig(
        ...
        self.process_ixs(&instructions,
                         additional_prio_fee_budget_microlamports,&[account]).await
    }
    ...
    pub async fn create_associated_token_account(&self, owner: &Pubkey,
                                                 additional_prio_fee_budget_microlamports: Option<f64>,) -> TokenResult<T::Output> {
    ...
    pub async fn get_or_create_associated_account_info(
        ...
        match self.get_account_info(&account).await {
            ...
            Err(TokenError::AccountNotFound) | Err(TokenError::AccountInvalidOwner) => {
                self.create_associated_token_account(owner, additional_prio_fee_budget_microlamports).await?;
    ...
    pub async fn mint_to<S: Signers>(
        ...
        self.process_ixs(&instructions,
                         additional_prio_fee_budget_microlamports,signing_keypairs).await
    }
    ...
    pub async fn transfer<S: Signers>(
        ...
        self.process_ixs(&[instruction],additional_prio_fee_budget_microlamports, signing_keypairs,
                         ).await
    }
    ...
    pub async fn burn<S: Signers>(
        ...
        self.process_ixs(&instructions, additional_prio_fee_budget_microlamports, signing_keypairs,
                         ).await
    }
    ...
    pub async fn sync_native(&self, account: &Pubkey,
                             additional_prio_fee_budget_microlamports: Option<f64>,) -> TokenResult<T::Output> {
        self.process_ixs::<[&dyn Signer; 0]>(
    ...
    pub async fn create_withdraw_proof_context_state<S: Signer>(
        ...
        self.process_ixs(
            &[instruction_type
                .encode_verify_proof(Some(withdraw_proof_context_state_info), withdraw_proof_data)],additional_prio_fee_budget_microlamports,
            &[] as &[&dyn Signer; 0],
        )
        .await
    }
    ...
    pub async fn confidential_transfer_transfer_with_split_proofs<S: Signers>(
        ...
        .await
        .map_err(|_| TokenError::AccountNotFound)?;
        self.process_ixs(&[instruction], additional_prio_fee_budget_microlamports,signing_keypairs).await
    }
    ...
    pub async fn confidential_transfer_transfer_with_split_proofs_in_parallel<S: Signers>(
        ...
        let transfer_with_equality_and_ciphertext_validity = self
            .create_equality_and_ciphertext_validity_proof_context_states_for_transfer_parallel(
                ...
                equality_and_ciphertext_validity_proof_signers,additional_prio_fee_budget_microlamports,
            );
        ...
        let transfer_with_range_proof = self
            .create_range_proof_context_state_for_transfer_parallel(
                ...
                &range_proof_data,
                &transfer_instruction,
                range_proof_signers,additional_prio_fee_budget_microlamports,
            );
    ...
    >(
        ...
        self.create_equality_and_ciphertext_validity_proof_context_state_with_optional_transfer(
            ...
            ciphertext_validity_proof_data,
            None,
            signing_keypairs,additional_prio_fee_budget_microlamports,
        )
        .await
    }
    ...
    pub async fn create_range_proof_context_state_for_transfer_parallel<S: Signers>(
        ...
        range_proof_data: &BatchedRangeProofU128Data,
        transfer_instruction: &Instruction,
        signing_keypairs: &S,additional_prio_fee_budget_microlamports: Option<f64>,
    ) -> TokenResult<T::Output> {
    ...
    pub async fn confidential_transfer_transfer_with_fee<S: Signers>(
        ...
        self.process_ixs_with_additional_compute_budget(
            &instructions,
            TRANSFER_WITH_FEE_COMPUTE_BUDGET,additional_prio_fee_budget_microlamports,
            signing_keypairs,
        )
        .await
    }
    ...
    >(
        ...
        range_proof_signers: &S,additional_prio_fee_budget_microlamports: Option<f64>,
        ...
        let transfer_with_fee_sigma_and_ciphertext_validity = self
            .create_fee_sigma_and_ciphertext_validity_proof_context_states_for_transfer_with_fee_parallel(
                ...
                &fee_ciphertext_validity_proof_data,
                &transfer_instruction,
                fee_sigma_proof_signers,additional_prio_fee_budget_microlamports,
            );
    ...
    pub async fn confidential_transfer_harvest_withheld_tokens_to_mint(
        &self,
        sources: &[&Pubkey],additional_prio_fee_budget_microlamports: Option<f64>,
    ) -> TokenResult<T::Output> {
        self.process_ixs::<[&dyn Signer; 0]>(
            &[
